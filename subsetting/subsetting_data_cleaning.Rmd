...
### David Springate
#### @datajujitsu
##### The Rmd source and data for this tutorial can be found at https://github.com/DASpringate/tutorials 
...
```{r, tidy = FALSE}
iris <- read.csv("~/tutorials/subsetting/iris_mangled.csv")
